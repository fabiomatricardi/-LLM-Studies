...
st.set_page_config(
    page_title="Your LocalGPT with 🟠 GGUF models",
    page_icon="🟠",
    layout="wide")

if "model_list" not in st.session_state:
    st.session_state.model_list = ("Aira2-124M", "DolphinQwen2-0.5b", "Gemma1.1-2b",
                                   "H2O-Danube2-1.8","Pythia70M-Chatsalad","StableLMZepyhr-1.6b",
                                   "HerculesQwen2-0.5b","Qwen2-1.5b",)
...
# Set HF API token  and HF repo
    from llama_cpp import Llama
    qwen05b = Llama(
                model_path='models/Aira-2-124M-DPO.Q8_0.gguf',
                n_gpu_layers=0,
                temperature=0.1,
                top_p = 0.5,
                n_ctx=2048,
    ...
    print('loading gemma-2b-zephyr-dpo.Q6_K.gguf with LlamaCPP...')
    return qwen05b
